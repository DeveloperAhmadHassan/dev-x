                ...
                <div className='container max-w-5xl'>
                    <div
                        ...
                        <div className='grid grid-cols-2 lg:grid-cols-3 p-2 px-4 md:pr-2 items-center'>
                            <div>
                                <Image src={logoImage} alt="DevX Logo" className='h-9 md:h-auto w-auto'/>
                            </div>
                            ...
                            <div className='flex justify-end gap-4'>
                                ...
                                >
                                    ...
                                    <line x1="3" y1="18" x2="21" y2="18"
                                          className={twMerge("origin-left", isOpen && '-rotate-45 translate-y-1')}></line>
                                </svg>
                                <Button variant="secondary" className='hidden md:inline-flex items-center'>Log
                                    In</Button>
                                <Button variant="primary" className='hidden md:inline-flex items-center'>Sign
                                    Up</Button>
                            </div>
                        </div>
                        <AnimatePresence>
