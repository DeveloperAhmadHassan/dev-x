                        ...
                        {ENTERPRISE_FEATURES.map((feature) => (
                            ...
                            >
                                <div className="relative">
                                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 flex items-center justify-center mb-4 ring-1 ring-gray-800/60 group-hover:ring-blue-500/20 group-hover:bg-blue-900/60">
                        ...
                        <div className="relative bg-[#12121a]/90 backdrop-blur-xl rounded-2xl">
                            ...
                            <div className="relative p-8 md:p-12">
                                ...
                                <div className="text-center mb-12">
                                    <div className="group inline-flex p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 ring-1 ring-gray-800/60 mb-6 hover:bg-blue-900/60 hover:-translate-y-1 transition-all duration-300">
