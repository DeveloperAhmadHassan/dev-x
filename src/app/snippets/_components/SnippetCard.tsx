...
function SnippetCard({ snippet, setDeleteDialogOpen, setDeleteId, isDeleting, setIsDeleting }: { snippet: Snippet, setDeleteDialogOpen: Dispatch<SetStateAction<boolean>>, setDeleteId: ()=>void, isDeleting: boolean, setIsDeleting: Dispatch<SetStateAction<boolean>> }) {
    const { user } = useUser();
