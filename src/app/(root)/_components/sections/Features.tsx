...
import Avatar from "@/app/(root)/_components/Avatar";
import Key from "@/app/(root)/_components/Key";
        ...
        <section className='py-24'>
            <div className='container'>
                ...
                <div className='mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8'>
                    <FeatureCard className='md:col-span-2 lg:col-span-1' title={"Real-time Collaboration"} description={"Work together seamlessly with conflict-free editing"}>
