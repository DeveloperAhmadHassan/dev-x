...
import {EditorPanelSkeleton} from "@/app/editor/_components/EditorPanelSkeleton";
import ShareSnippetDialog from "@/app/editor/_components/ShareSnippetDialog";

const EditorPanel = () => {
    const clerk = useClerk();
    const [isShareDialogOpen, setIsShareDialogOpen] = useState(false);
    const {fontSize, language, theme, editor, setFontSize, setEditor} = useCodeEditorStore();
